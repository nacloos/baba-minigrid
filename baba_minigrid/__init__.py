...
from baba_minigrid.minigrid import Wall
...
def register_minigrid_envs():
    ...
    register(
        ...
        entry_point="baba_minigrid.envs.babaisyou:GoToObjEnv"
    )
    register(
        id="BabaIsYou-GoToWinObj-v0",
        entry_point="baba_minigrid.envs.babaisyou:GoToWinObjEnv"
    )
    register(
        id="BabaIsYou-ChangeRule-v0",
        entry_point="baba_minigrid.envs.babaisyou:ChangeRuleEnv"
    )
    register(
        id="BabaIsYou-TestRule-v0",
        entry_point="baba_minigrid.envs.babaisyou:TestRuleEnv"
    )
    register(
        id="BabaIsYou-MoveBlock-v0",
        entry_point="baba_minigrid.envs.babaisyou:MoveBlockEnv"
    )
    register(id="BabaIsYou-MoveObj-v0",
        entry_point="baba_minigrid.envs.babaisyou:MoveObjEnv"
    )
    register(id="BabaIsYou-OpenShutObj-v0",
        entry_point="baba_minigrid.envs.babaisyou:OpenShutObjEnv"
    )
    register(id="BabaIsYou-OpenAndGoToWin-v0",
        entry_point="baba_minigrid.envs.babaisyou:OpenAndGoToWinEnv"
    )
    register(id="BabaIsYou-FourRoomEnv-v0",
        entry_point="baba_minigrid.envs.babaisyou:FourRoomEnv"
    )
    register(
        id="BabaIsYou-MakeRule-v0",
        entry_point="baba_minigrid.envs.babaisyou:MakeRuleEnv"
    )
    register(
        id="BabaIsYou-Test-v0",
        entry_point="baba_minigrid.envs.babaisyou:TestEnv"
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:BlockedUnlockPickupEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:CrossingEnv",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:DistShiftEnv",
        kwargs={"strip2_row": 2},
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:DoorKeyEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:DynamicObstaclesEnv",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:EmptyEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:FetchEnv",
    ...
    register(id="MiniGrid-Fetch-8x8-N3-v0", entry_point="baba_minigrid.envs:FetchEnv")
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:FourRoomsEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:GoToDoorEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:GoToObjectEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:KeyCorridorEnv",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:LavaGapEnv",
        kwargs={"size": 5},
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:LockedRoomEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:MemoryEnv",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:MultiRoomEnv",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:ObstructedMaze_1Dlhb",
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:ObstructedMaze_Full",
        kwargs={
            "agent_room": (2, 1),
            "key_in_box": False,
            "blocked": False,
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:PlaygroundEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:PutNearEnv",
    )
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:RedBlueDoorEnv",
        kwargs={"size": 6},
    )
    ...
    register(id="MiniGrid-Unlock-v0", entry_point="baba_minigrid.envs:UnlockEnv")
    ...
    register(
        ...
        entry_point="baba_minigrid.envs:UnlockPickupEnv",
    )
